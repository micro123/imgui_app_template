/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.36 on Fri Oct 21 01:12:25 2022.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=3.0, gles1=1.0, gles2=3.0
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.0,gles1=1.0,gles2=3.0" --generator="c" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D3.0&api=gles1%3D1.0&api=gles2%3D3.0
*/
...
char const* gl_error_str(GLenum err)
{
    switch (err)
    {
        // opengl 2 errors (8)
